...
public class Unwavering extends BasicGameState {
    ...
    public ArrayList<Enemy> I = new ArrayList();
    ...
    public void init(GameContainer gc, StateBasedGame sbg)
		...
		// Scenerey Stuff
		// ****************
        grassMap = new TiledMap("res/Nash_3_Dungeon.tmx");
        ...
        Isaiah = new Enemy(1170, 1550);
        I.add(Isaiah);

        antidote = new Itemwin(1890, 2802);
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
       ...
       // g.drawString("x: " + (int) Player.x + "y: " + (int) Player.y, Player.x, Player.y - 10);
        ...
        Isaiah.currentanime.draw(Isaiah.Bx, Isaiah.By);
        //g.drawString("enemy x: " + (int) Isaiah.Bx + "y: " + (int) Isaiah.By, Player.x - 120, Player.y - 110);
